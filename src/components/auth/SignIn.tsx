  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#10151a] via-[#19391a] via-40% to-[#0c1a13] to-90% font-sans text-gray-300 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full mx-auto bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl border border-[#A8FFBA]/30 p-8 md:p-14">
        <h2 className="text-center text-3xl font-bold text-white font-display tracking-tight leading-tight mb-2">Sign in to your account</h2>
        <p className="text-center text-sm text-gray-300 mb-6">
          Or{' '}
          <Link to="/signup" className="font-medium text-[#A8FFBA] hover:text-[#51B73B]">create a new account</Link>
        </p>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-[#A8FFBA] hover:text-[#51B73B]">Forgot your password?</Link>
            </div>
          </div>
          <div>
            <button
